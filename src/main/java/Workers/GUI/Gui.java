            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    try {
                        ...
                        Object[] row = { neuerMitarbeiter.getID(), neuerMitarbeiter.getName(),
                                neuerMitarbeiter.einkommen() };
                        tableModel.addRow(row);
                    } catch (NumberFormatException ex) {
                        JOptionPane.showMessageDialog(frame, "Ungültige Eingabe. ID und Gehalt müssen Zahlen sein.",
        ...
        removeButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow >= 0) {
                    ...
                    JOptionPane.showMessageDialog(frame, "Bitte eine Zeile auswählen.", "Fehler",
